...
export const NOTE_TEMPLATES: NoteTemplate[] = [
  ...
  // 以下模板对应 docs/notes-charter.md 的页面类型（page types）。
  {
    id: 'paper-card',
    label: '论文卡片',
    description: '一页文献档案：问题、方法、实验、我的判断',
    content: [
      headingNode(2, '一句话总结'),
      paragraphNode(),
      headingNode(2, '研究问题'),
  ...
  },
  {
    id: 'synthesis',
    label: '综述页',
    description: '跨文献比较、归纳、研究脉络',
    content: [
      headingNode(2, '主题与范围'),
      paragraphNode(),
      headingNode(2, '代表工作'),
      bulletListNode(['用 / 插入文献引用（paper reference）']),
      headingNode(2, '横向比较'),
      paragraphNode(),
      headingNode(2, '共识与分歧'),
      paragraphNode(),
  ...
  },
  {
    id: 'excerpt-card',
    label: '摘录卡',
    description: '提炼式摘录：来源锚点保真、正文自由改写',
    content: [
      headingNode(2, '来源'),
      paragraphNode('（用 / 插入文献引用或摘录锚点；锚点不可手改）'),
      headingNode(2, '提炼'),
      paragraphNode('（用自己的话重写要点，可自由改写）'),
      headingNode(2, '原文快照'),
      paragraphNode('（如保留原文，放在此处且不再修改）'),
      headingNode(2, '我的推断'),
  ...
  },
  {
    id: 'index-page',
    label: '索引页',
    description: '主题入口：双链目录，少写正文',
    content: [
      headingNode(2, '核心概念'),
      bulletListNode(['[[概念页标题]]']),
      headingNode(2, '论文卡片'),
      bulletListNode(['[[论文卡片标题]]']),
      headingNode(2, '待办'),
      taskListNode(['待整理的笔记']),
    ],
  },
  {
    id: 'research-log',
    label: '研究日志',
    description: '按日期推进的实验/阅读日志',
    content: [
      headingNode(2, 'YYYY-MM-DD'),
      bulletListNode(['今天做了什么', '观察到什么', '卡在哪里']),
      headingNode(2, '下一步'),
      taskListNode(['明天第一件事']),
    ],
  },
  {
    id: 'overview-page',
    label: '总览页',
    description: '全局研究状态：进行中、待读、待写',
    content: [
      headingNode(2, '进行中的问题'),
      bulletListNode(['当前主攻问题']),
      headingNode(2, '待读'),
      taskListNode(['待读论文']),
      headingNode(2, '待写'),
      taskListNode(['计划产出']),
