// 由 scripts/build-office-addin.mjs 生成，请勿手改；源文件：office-addin/src/core.ts
"use strict";
...
var PaperQuayWord = (function () {
    ...
    // office-addin/src/core.ts
    var core_exports = {};
    __export(core_exports, {
        API_BASE: function () { return API_BASE; },
        CITATION_STYLE_IDS: function () { return CITATION_STYLE_IDS; },
        CLIENT_HEADER: function () { return CLIENT_HEADER; },
        createBridgeClient: function () { return createBridgeClient; },
        createOperations: function () { return createOperations; },
        createTaskQueue: function () { return createTaskQueue; },
        parseModelXml: function () { return parseModelXml; },
        planRender: function () { return planRender; },
        renderCitations: function () { return renderCitations; },
        serializeModelXml: function () { return serializeModelXml; }
    });
    ...
    function formatNumericSegments(items, seqs) {
        ...
        ranges.forEach(function (_g, index) {
            var _h = __read(_g, 2), start = _h[0], end = _h[1];
            if (index > 0)
                core.push({ text: "," });
            core.push({ text: "".concat(start), paperId: paperIdBySeq.get(start) });
            if (end > start) {
                core.push({ text: "-" });
    ...
    function recordRendered(model, outputs, written) {
        ...
        return __spreadProps(__spreadValues({}, model), {
            citations: model.citations.map(function (citation) {
                var output = byId.get(citation.citeId);
    ...
    function createOperations(adapter, createId) {
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, adapter.writeModelXml(serializeModelXml(saved))];
                        case 1:
                            _g.sent();
                            model = saved;
                            return [2 /*return*/];
        ...
        function loadModel() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_h) {
                    switch (_h.label) {
                        case 0: return [4 /*yield*/, adapter.readModelXml()];
                        case 1:
                            xmls = _h.sent();
                            stored = pickLatestModel(xmls).model;
                            schema = String((_a = adapter.getSetting(SCHEMA_VERSION_SETTING_KEY)) != null ? _a : "");
                            if (!stored) return [3 /*break*/, 2];
                            model = stored;
                            return [3 /*break*/, 6];
                        case 2:
                            if (!(schema !== String(DOCUMENT_MODEL_SCHEMA_VERSION) && adapter.getSetting("pq:citations") != null)) return [3 /*break*/, 5];
                            model = migrateV1Settings(function (key) { return adapter.getSetting(key); });
                            return [4 /*yield*/, persist(model)];
                        case 3:
                            _h.sent();
                            return [4 /*yield*/, adapter.setSettings((_g = {}, _g[SCHEMA_VERSION_SETTING_KEY] = String(DOCUMENT_MODEL_SCHEMA_VERSION), _g), __spreadArray([], __read(V1_SETTING_KEYS), false))];
                        case 4:
                            _h.sent();
        ...
        function refresh() {
            return __awaiter(this, arguments, void 0, function (options) {
                var _a, scan, splits, working, applied, texts, splits_1, splits_1_1, split, known, missingSnapshots, plan, diff, rewrite, pending, _g, _h, edit, _j, _k, edit, updates;
                var e_25, _l, e_26, _m, e_27, _o;
                if (options === void 0) { options = {}; }
                    ...
                    switch (_p.label) {
                        ...
                        case 3:
                            ...
                            try {
                                ...
                                try {
                                    if (splits_1_1 && !splits_1_1.done && (_l = splits_1.return)) _l.call(splits_1);
                                }
                        ...
                        case 7:
                            ...
                            return [4 /*yield*/, adapter.rewriteCitations(updates)];
                        case 8:
                            _p.sent();
                            _p.label = 9;
                        case 9:
                            if (!scan.hasBibliography) return [3 /*break*/, 11];
                            return [4 /*yield*/, adapter.writeBibliography(plan.bibliographyOoxml, plan.bibliographyText, "update")];
                        case 10:
                            _p.sent();
                            _p.label = 11;
                        case 11:
        ...
        function insertCitation(items, papers) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        ...
                        case 2:
                            _g.sent();
                            return [4 /*yield*/, adapter.insertCitation(citeId, first.ooxml, first.text)];
                        case 3:
                            _g.sent();
                            return [2 /*return*/, refresh({ manualEdits: "ask" })];
                    }
                });
            });
        }
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        ...
                        case 1:
                            _g.sent();
                            return [4 /*yield*/, adapter.deleteCitation(citeId)];
                        case 2:
                            _g.sent();
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, adapter.writeBibliography(plan.bibliographyOoxml, plan.bibliographyText, "insertAtSelection")];
                        case 3:
                            _g.sent();
                            _g.label = 4;
                        case 4: return [2 /*return*/, refresh({ manualEdits: "ask" })];
                    }
                });
            });
        }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        ...
                        case 1:
                            _g.sent();
                            return [4 /*yield*/, adapter.unlinkAll(stripLinks)];
                        case 2:
                            removed = _g.sent();
